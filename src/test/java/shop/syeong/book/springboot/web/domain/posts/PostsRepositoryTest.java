package shop.syeong.book.springboot.web.domain.posts;
...
public class PostsRepositoryTest {
    ...
    public void 게시글저장_불러오기() {
        ...
        postsRepository.save(Posts.builder()
                .title(title)
                .content(content)
                .author("syeong@gmail.com")
                .build());
        // .save - 테이블 posts에 insert/update 쿼리 실행, id 값 있으면 update / id 값 없으면 insert
    ...
    public void BaseTimeEntity_등록 () {
        ...
        System.out.println(">>>>>>>>>> creatData = " + posts.getCreatedDate() + ", modifiedData = " + posts.getModifiedDate());
